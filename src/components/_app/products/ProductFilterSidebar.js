...
export const FILTER_GENDER_OPTIONS = ['Mariscos', 'Bebidas', 'Botanas'];
export const FILTER_CATEGORY_OPTIONS = ['Todas', 'Platillos', 'Productos'];
export const FILTER_RATING_OPTIONS = ['up4Star', 'up3Star', 'up2Star', 'up1Star'];
export const FILTER_PRICE_OPTIONS = [
  { value: 'below', label: 'Menor $25' },
  { value: 'between', label: 'Entre $25 - $75' },
  { value: 'above', label: 'Mayor $75' }
];
